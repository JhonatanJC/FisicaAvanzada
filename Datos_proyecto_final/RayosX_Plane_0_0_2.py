...
def plot_cube(cube_definition):
    ...
    fig.plot_surface(xx, yy, np.full(z.shape, 0.5), alpha=0.6)
    ...
    Points_inter = np.array([np.array([1,1,0,0,1]),np.array([1,0,0,1,1]),np.array([0.5,0.5,0.5,0.5,0.5])])
    ...
    ax.set_title("Planos cristalográficos para el indice de Miller [0, 0, 2]", fontsize=28)
    ax.set_aspect('auto')
