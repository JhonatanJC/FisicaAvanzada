...
def plot_cube(cube_definition):
    ...
    Points_inter = np.array([np.array([1,0,0,1]),np.array([0,0,1,0]),np.array([0,1,0,0])])
    ...
    ax.set_title("Planos cristalográficos para el indice de Miller [1, 1, 1]", fontsize=28)
