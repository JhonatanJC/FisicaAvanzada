...
def plot_cube(cube_definition):
    ...
    fig.plot_surface(np.full(z.shape, 0.5), yy, z, alpha=0.6)
    ...
    Points_inter = np.array([np.array([0.5,0.5,0.5,0.5,0.5]),np.array([0,0,1,1,0]),np.array([0,1,1,0,0])])
    ...
    ax.set_title("Planos cristalográficos para el indice de Miller [2, 0, 0]", fontsize=28)
    ax.set_aspect('auto')
